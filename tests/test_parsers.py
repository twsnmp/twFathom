...
class TestParsers(unittest.TestCase):
    def test_environment_json_single(self):
        payload = '{"temp": 25.4, "humidity": 60.2, "pressure": 1011.5, "co2": 520, "soil_moisture": 28.1}'
    ...
    def test_environment_csv(self):
        payload = "temp,humidity,pressure,co2,soil\n22.5,50.1,1013.2,450,30.5\n23.0,51.0,1012.9,455,31.0"
        dtype, results = auto_parse_and_map(payload)
